...
[https://github.com/jupyter-server/jupyter_server/services/api/api.yaml]: https://github.com/jupyter-server/jupyter_server/blob/v2.14.2/jupyter_server/services/api/api.yaml
